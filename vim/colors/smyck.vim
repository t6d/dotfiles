...
hi StatusLine           cterm=bold ctermbg=15       ctermfg=8       gui=bold        guibg=#454545   guifg=#FBFBFB
hi StatusLineNC         cterm=bold ctermbg=8        ctermfg=15      gui=bold        guibg=#303030   guifg=#FBFBFB
hi VertSplit            cterm=bold ctermbg=15       ctermfg=15      gui=bold        guibg=#303030   guifg=#303030
